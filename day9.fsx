...
ops |> Seq.scan (add) (0, 0) |> tail |> Seq.distinct |> Seq.length |> printfn "Answer1: %A"
ops |> Seq.scan (add) (0, 0) |> tail |> tail |> tail |> tail |> tail |> tail |> tail |> tail |> tail |> Seq.distinct |> Seq.length |> printfn "Answer2: %A"